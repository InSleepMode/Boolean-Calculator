...
Интерпретатор булевских выражений, который поддерживает операции:
...
Калькулятор строит таблицу истинности для булевых функций, конъюнктивную и дизъюнктивную нормальные формы, полином Жегалкина, проверяет систему функций на полноту.
